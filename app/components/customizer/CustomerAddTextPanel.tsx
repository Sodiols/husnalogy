  ...
  return (
    <div className="grid gap-4 p-4">
      <button
        type="button"
        onClick={onAddText}
        className="flex items-center justify-center gap-2 rounded-lg border border-[#303839]/15 bg-white px-4 py-3 text-sm font-bold text-[#303839] transition hover:bg-[#303839]/5"
      >
