...
const permissions = { select: true, editContent: true, editStyle: true, group: true, ungroup: true, hide: true, lock: true, changeFont: true, changeFontSize: true, changeColor: true, changeTextColor: true, changeAlignment: true, changeLetterSpacing: true, changeLineHeight: true, changeFontWeight: true, changeFontStyle: true, move: true, resize: true, rotate: true, duplicate: true, delete: true, changeOpacity: true, changeLayerOrder: true, replaceImage: true, cropImage: true, zoomImage: true, repositionImage: true, flipImage: true, rotateImage: true, applyImageFilters: true, changeFill: true, changeBorder: true, editGrid: true, editGridLayout: true, moveGridPhotos: true, editQRCodeValue: true, editQRCodeStyle: true };
const pages = [
...
const settings = { templateName: "Customizer V2 E2E", allowCustomerText: true, allowCustomerUploads: true, allowCustomerElements: true, allowCustomerShapes: true, allowCustomerLines: true, allowCustomerFrames: true, allowCustomerGrids: true, allowCustomerQRCodes: true, allowCustomerBackground: true, allowCustomerGrouping: true, showCustomerLayers: true, requireApprovalCheckbox: true, protectedPreview: true, autosave: true, featureFlags: {} };
